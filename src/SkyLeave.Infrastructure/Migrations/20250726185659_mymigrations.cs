    ...
    public partial class mymigrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1111, 0, "", "Alice Johnson", new DateTime(2025, 8, 1, 0, 0, 0, 0, DateTimeKind.Local), "Vacation", new DateTime(2025, 7, 29, 0, 0, 0, 0, DateTimeKind.Local), "Pending" },
                    { 2111, 0, "", "Bob Smith", new DateTime(2025, 8, 2, 0, 0, 0, 0, DateTimeKind.Local), "Medical Leave", new DateTime(2025, 7, 30, 0, 0, 0, 0, DateTimeKind.Local), "Approved" }
                });
        }
